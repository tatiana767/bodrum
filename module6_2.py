...
class Vehicle:
    ...
    def get_model(self):
        ...
        return  '\nМодель:'+str(self.__model)

    def get_housepower(self):

        return '\nMOщность: '+str(self.__engine_power)
    ...
    def print_info(self):
        ...
        print(self.get_model(), self.get_housepower(), self.get_color(), '\n', self.owner)

    def set_color(self, new_color):

        if self.__COLOR_VARIANTS.__contains__(str(new_color).lower()) :
